...
public class Converter extends DefaultHandler {
    ...
    private final List<IndicatorType> typesOfVariables = new ArrayList<IndicatorType>();
    ...
    private Converter(PMStationSPSSWriter spsswriter) {
        writer = spsswriter;
    }
    ...
    public static void convert(InputStream inputstream, PMStationSPSSWriter spsswriter) throws IOException, SAXException {
        Converter converter = new Converter(spsswriter);
        spsswriter.addDictionarySection();
        XMLHelper.parseXML(new InputSource(inputstream), converter);
